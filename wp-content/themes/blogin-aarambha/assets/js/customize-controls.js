...
( function( $, api ) {
     ...
     */
    const blogin_aarambha_linked = ( id, key ) => {
     ...
     * @param key target class
     */
    const blogin_aarambha_unlinked = ( key ) => {
     ...
     * @param customizerTab
     */
    const blogin_aarambha_hide_controls = ( customizerSection , customizerTab ) => {
     ...
     */
    const blogin_aarambha_show_controls = ( customizerSection, controlsToShowArray ) => {
     ...
     * @return string
     */
    const blogin_aarambha_format_Text = ( icon ) => {
	...
	$( document ).ready( function() {
		...
		$( '.customizer-group-control' ).each( function () {
			let customizerSection   = $( this ).closest( '.accordion-section' ),
				customizerTab       = $(this).closest('.customize-control-blogin_aarambha_group').attr('id'),
				shownCtrls          = $(this).find( '.customizer-tab > .active' ).data( 'controls' );

			// Hide all controls in section.
			blogin_aarambha_hide_controls( customizerSection, customizerTab );

			// Show controls under first radio button.
			blogin_aarambha_show_controls( customizerSection, shownCtrls.split(',') );

		} );
	} );

    api.sectionConstructor['blogin_aarambha_custom_section'] = api.Section.extend( {
    ...
    /**
     * Customizer Control: blogin_aarambha_background
     */
    api.controlConstructor['blogin_aarambha_background'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_background',control.container);
    ...
    /**
     * Customizer Control: blogin_aarambha_border
     */
    api.controlConstructor['blogin_aarambha_border'] = api.Control.extend( {
                ...
                if ( item === 'width' ) {
                    ...
                    if ( values[item] !== undefined && values[item]['linked'] !== undefined ) {
                        ...
                        if ( values[item]['linked'] === 'on' ) {
                            blogin_aarambha_linked( control.id, 'border-control' );
                        }
                        else {
                            blogin_aarambha_unlinked( 'border-control' );
                        }
                    }
                }
                // for radius
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_border',control.container);
    ...
    /**
     * Customizer Control: blogin_aarambha_box_shadow
     */
    api.controlConstructor['blogin_aarambha_box_shadow'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_box_shadow',control.container);
	...
	/**
	 * Customizer Control: blogin_aarambha_typography
	 */
	api.controlConstructor['blogin_aarambha_typography'] = api.Control.extend( {
		...
		ready: function() {
			...
			// Font Options
			control.selectFontOptions( window.AllFonts['allFonts'] );
				...
				if ( item === 'font_family' ) {
					...
					if ( v ) {
						...
						if ( typeof id !== 'undefined') {
							if ( typeof window.AllFonts['allFonts'][id] !== 'undefined') {
								let font = window.AllFonts['allFonts'][id];
								css[item] = font.name;
							}
						}
					}
		...
		resetValues: function(){
			...
			control.container.on( 'click', '.reset-value', function() {
				...
				const holder = $( this ).closest('.customize-control-blogin_aarambha_typography',control.container);
		...
		setFontVariants: function( font_id ){
			...
			if ( typeof window.AllFonts['allFonts'][ font_id ] !== 'undefined' && font_id !== '' ) {

				_.each( window.AllFonts['allFonts'][ font_id ]['font_variants'], function (value, id) {
    ...
    /**
     * Customizer Control: blogin_aarambha_sortable
     */
    api.controlConstructor['blogin_aarambha_sortable'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder 	= $( this ).closest('.customize-control-blogin_aarambha_sortable',control.container);
    ...
    /**
     * Customizer Control: blogin_aarambha_group
     */
    api.controlConstructor['blogin_aarambha_group'] = api.Control.extend( {
        ...
        ready: function() {
            ...
            control.container.on( 'click', '.customizer-tab > label', function( e ) {
                ...
                // Hide all controls in section
                blogin_aarambha_hide_controls( customizerSection, customizerTab );
                blogin_aarambha_show_controls( customizerSection, controls.split(',') );
    ...
    /**
     * Customizer Control: blogin_aarambha_toggle
     */
    api.controlConstructor['blogin_aarambha_toggle'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_toggle',control.container);
    ...
    /**
     * Customizer Control: blogin_aarambha_color
     */
    api.controlConstructor['blogin_aarambha_color'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_color',control.container);
    ...
    /**
     * Customizer Control: blogin_aarambha_buttonset
     */
    api.controlConstructor['blogin_aarambha_buttonset'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_buttonset',control.container)
    ...
    /**
     * Customizer Control: blogin_aarambha_range
     */
    api.controlConstructor['blogin_aarambha_range'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_range',control.container);
    ...
    /**
     * Customizer Control: blogin_aarambha_dimensions
     */
    api.controlConstructor['blogin_aarambha_dimensions'] = api.Control.extend( {
                ...
                if ( values[key] !== undefined ) {
                    ...
                    if ( values[key]['linked'] !== undefined ) {
                        ...
                        if ( values[key]['linked'] === 'on' ) {
                            blogin_aarambha_linked( control.id, key );
                        }
                        else {
                            blogin_aarambha_unlinked( key );
                        }
                    }
                }
            });
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_dimensions',control.container);
                ...
                holder.find( '.dimensions-control .link-dimensions input[type="hidden"]' ).each( function() {
                    ...
                    if ( r === 'on' ) {
                        blogin_aarambha_linked( control.id, 'dimensions-control' );
                    }
                    else {
                        blogin_aarambha_unlinked( 'dimensions-control' );
                    }
                });
    ...
    /**
     * Customizer Control: blogin_aarambha_radio_image
     */
    api.controlConstructor['blogin_aarambha_radio_image'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-blogin_aarambha_radio_image',control.container);
    ...
    /**
     * Customizer Control: blogin_aarambha_select
     */
    api.controlConstructor['blogin_aarambha_select'] = api.Control.extend( {
    ...
    /**
     * Customizer Control: blogin_aarambha_icon_select
     */
    api.controlConstructor['blogin_aarambha_icon_select'] = api.Control.extend( {
        ...
        ready: function() {
            ...
            let control  = this,
                ...
                select2Options = {
                    ...
                    allowClear: true,
                    templateSelection: blogin_aarambha_format_Text,
                    templateResult: blogin_aarambha_format_Text
                };
    ...
    /**
     * Customizer Control: blogin_aarambha_editor
     */
    api.controlConstructor['blogin_aarambha_editor'] = api.Control.extend( {
        ready : function () {
    ...
    /**
     * Customizer Control: blogin_aarambha_multi_select
     */
    api.controlConstructor['blogin_aarambha_multi_select'] = api.Control.extend( {
